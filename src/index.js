...
const data = {
    recommendations: [
        {
            id: '0',
            title: 'Möbelindustrie 2030: Super krasse Möbel möblieren das ohnehin fantastische Mobiliar',
            author: 'Feyen, F.',
            publishingYear: '2016',
            thumbsUps: 23,
        ...
        {
            id: '2',
            title: 'Seismische Vibrationsmessung für Rasterkraftelektronenmikroskopie',
            author: 'Leißner, J.F.',
            publishingYear: '2018',
            thumbsUps: 230,
            thumbnail: 'ein thumbnail'
...
const bootstrap = () => {
    console.log('Hello Dozent View! Today is a nice day. This is nice.');
...
const chooseListClick = () => {
    ...
    let index = 0;
    for (index = 0; index < customLists.length || customLists[i].title === selectValue; index++) {}
...
const renderCurrentCustomList = () => {
    ...
    customLists[currentCustomListIndex].list.forEach(item => addListItemToDom(domList, item, 'custom'));
};
